@php
    ...
    $imageChange = old($field['name'] . '_change');
    $imageChange = $imageChange == 1 ? true : false;
    $value = old(square_brackets_to_dots($field['name'])) ?? $field['value'] ?? $field['default'] ?? '';
    if($imageChange && old(square_brackets_to_dots($field['name'])) == null){
        $value = null;
    }
...
@include('crud::fields.inc.wrapper_start')
    ...
    <div class="btn-group">
        <div class="btn btn-light btn-sm btn-file">
            ...
            <input type="hidden" data-handle="imageChange" name="{{ $field['name'] . '_change'}}" value="{{$imageChange}}">
        </div>
        @if(isset($field['crop']) && $field['crop'])
    ...
    @push('crud_fields_scripts')
        ...
        <script>
            function bpFieldInitCropperImageElement(element) {
                    ...
                    var $imageChange = element.find("[data-handle=imageChange]");
                    ...
                    if(!$hiddenImage.val().startsWith('data:image/')){
                        $hiddenImage.val('');
                    }
