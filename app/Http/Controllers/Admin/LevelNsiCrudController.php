...
use App\Http\Requests\LevelNsiRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class LevelNsiCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class LevelNsiCrudController extends CrudController
{
    ...
    {
        CRUD::column('min_sold');
        CRUD::column('bonus_percentage');
    ...
    {
        CRUD::setValidation(LevelNsiRequest::class);

        CRUD::field('min_sold');
        CRUD::field('bonus_percentage');
